...
import edu.uncc.assignment14.db.AppDatabase;
...
public class MainActivity extends AppCompatActivity implements BillsFragment.BillsListener, BillSummaryFragment.BillSummaryListener, CreateBillFragment.CreateBillListener, SelectCategoryFragment.SelectCategoryListener, SelectDiscountFragment.SelectDiscountListener, SelectBillDateFragment.SelectDateBillListener, EditBillFragment.EditBillListener
{
    AppDatabase db;
    ...
    public ArrayList<Bill> getAllBills() {
        ...
        ArrayList<Bill> bills = (ArrayList<Bill>) db.billDAO().getAll();
        return bills;
    }
